...
export default function Nav(props: propstype){
    ...
    return(
        <nav className="h-[50px] w-[100%] border-b border-b-[#c7c7c7a2] fixed top-[0] flex justify-start items-center select-none bg-[white] ">
         <div onClick={()=>{handlemove('/home')}} className="h-[45px] w-[45px] ml-[50px] flex justify-center items-center">
         ...
         <h1 onClick={()=>{handlemove('/home')}} className="text-[28px] text-[#424052] font-[500] ml-2 cursor-pointer">{props.title}</h1>
        ...
        <button onClick={()=>{props.logout()}} className="h-[37px] w-[90px] text-[white] rounded bg-[#11E980] ml-3 select-none cursor-pointer relative left-[1300px]">Log Out</button>
         ...
         <div onClick={()=>{handlemove('/profile')}} className="h-[45px] w-[45px] ml-5  flex justify-center items-center select-none cursor-pointer relative left-[1300px]">
